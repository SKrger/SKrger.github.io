...
I’m looking for an opportunity to contribute as a data analyst while continuing to grow toward data engineering and data science. The kind of team that appeals to me values curiosity, good collaboration, and the discipline to build data work people can rely on.

<a class="button button--primary" href="{{ '/projects/' | relative_url }}">See how I work</a>
<a class="button button--secondary" href="https://www.linkedin.com/in/sally-krger/">Connect on LinkedIn</a>
